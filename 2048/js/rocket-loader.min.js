			...
			this.scriptStack.forEach(function(e) {
				if (a(e, t.settings.nonce)) {
					...
					if (n && !r) {
						...
						o.setAttribute("rel", "preload"), o.setAttribute("as", "script"), o.setAttribute("href", n), e.crossOrigin && o.setAttribute("crossorigin", e.crossOrigin),  t.preloadHints.push(o)
					}
				}
			})
